...
<div>
  <main>
    ...
    <p class="description">
      Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://codepet.sentry.io/issues/?project=4509538413969408">Issues Page</a>. 
