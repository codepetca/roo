// Test the improved parser with real submission data
...
const result = parseKarelQuizSubmission(submissionText);
console.log('Parsed answers:');
console.log(JSON.stringify(result, null, 2));
console.log('\nTotal questions parsed:', Object.keys(result).length);