...
import { mockData, createMockClassroomResponse, createMockAssignmentResponse } from '../test-utils/mock-data';
...
describe('Classroom Store', () => {
  ...
  describe('Loading Assignments', () => {
    ...
    it('should load assignments for selected classroom', async () => {
      ...
      expect(mockApi.getClassroomAssignments).toHaveBeenCalledWith(classroomStore.selectedClassroomId);
