 ...
 */
export function createMockAssignment(overrides: Partial<AssignmentWithStats> = {}): AssignmentWithStats {
  return {
    id: 'assignment-1',
 ...
 */
export function createMockSubmission(overrides: Partial<SubmissionSnapshot> = {}): SubmissionSnapshot {
  return {
    id: 'submission-1',
 ...
 */
export function createMockClassroomSnapshot(overrides: Partial<ClassroomSnapshot> = {}): ClassroomSnapshot {
 ...
 */
export function createMockClassroomResponse(overrides: Partial<ClassroomResponse> = {}): ClassroomResponse {
  return {
    id: 'classroom-1',
    name: 'CS 101: Introduction to Programming',
    courseCode: 'CS101',
 ...
 */
export function createMockAssignmentResponse(overrides: Partial<AssignmentResponse> = {}): AssignmentResponse {
  return {
    id: 'assignment-1',
