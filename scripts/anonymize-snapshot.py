    ...
    def replace_identifiers(obj):
        if isinstance(obj, dict):
            ...
            for key, value in obj.items():
                ...
                # Replace student emails
                elif key == "email" and "@gapps.yrdsb.ca" in str(value):
                    ...
                    if student_number.isdigit():  # Only reverse if it's a student number
                        ...
                        new_obj[key] = value
                # Replace names
                elif key in ["name", "displayName"] and isinstance(value, str) and value in name_mapping:
                ...
                # Replace Google URLs with placeholders
                elif key in ["alternateLink", "formUrl", "responseUrl", "thumbnailUrl"]:
                    ...
                    elif "googleusercontent.com" in str(value):
